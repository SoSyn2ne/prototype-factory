...
## Happy path
- The first screen shows the actual working workflow for Med Fee Pushback File.
- All required UI sections are represented.
- The assigned design profile is visually reflected: calm-consumer.
