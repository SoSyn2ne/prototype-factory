...
- The main CTA advances the key UX: Parent enters target start date, centers, waitlist fees, tour notes, age-room openings, commute, and backup caregivers; the app ranks which centers need calls, deposits, or fallback plans.
