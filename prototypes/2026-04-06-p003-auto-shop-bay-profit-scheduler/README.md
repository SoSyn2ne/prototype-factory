# Auto Shop Bay Profit Scheduler

A repair-shop ops board that exposes which service bays are leaking margin through schedule gaps, overtime creep, and low-yield jobs.
