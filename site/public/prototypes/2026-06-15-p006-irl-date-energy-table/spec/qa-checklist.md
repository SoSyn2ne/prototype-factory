...
## Happy path
- The first screen shows the actual working workflow for IRL Date Energy Table.
- All required UI sections are represented.
- The assigned design profile is visually reflected: playful-experimental.
