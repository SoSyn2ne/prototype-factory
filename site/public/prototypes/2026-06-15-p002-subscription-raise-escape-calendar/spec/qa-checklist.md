...
## Happy path
- The first screen shows the actual working workflow for Subscription Raise Escape Calendar.
- All required UI sections are represented.
- The assigned design profile is visually reflected: financial-analyst.
