...
## Happy path
- Users can scan the unit pipeline, open one audio, and understand tasks, blockers, vendors, and readiness state immediately.
...
- Demo stays stubbed, but the information architecture must support playful-experimental handoff and blocker management.
