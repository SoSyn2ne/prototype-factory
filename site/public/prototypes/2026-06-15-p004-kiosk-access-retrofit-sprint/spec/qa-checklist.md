...
## Happy path
- The first screen shows the actual working workflow for Kiosk Access Retrofit Sprint.
- All required UI sections are represented.
- The assigned design profile is visually reflected: field-ops.
