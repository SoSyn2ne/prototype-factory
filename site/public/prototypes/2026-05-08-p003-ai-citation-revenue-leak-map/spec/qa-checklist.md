...
- The visual direction follows `financial-analyst` and does not drift into a generic dashboard.
...
- Stitch export for this slot should land in `/home/sy/Downloads/stitch_drop/2026-05-08/p003/`.
